...
focused on ``protein''.\\
This topic was of central importance that year, which may explain why a Nobel
...
\noindent The preceding query returns, for each state, the number of laureates who were born in that state but conducted research abroad, and the number of
