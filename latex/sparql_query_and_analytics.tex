...
The following query returns, for each state, the number of laureates who were born in that state and the number of
laureates who have worked in an organization located in that state, in addition to being born there.
\begin{lstlisting}
PREFIX : <http://www.semanticweb.org/a3d/ontologies/2024/10/nobelOntology/>
PREFIX foaf: <http://xmlns.com/foaf/0.1/>
